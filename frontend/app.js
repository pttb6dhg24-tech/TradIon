...
const I18N = {
  es: {
    ...
    plan_hint: 'Arrastra a cada persona a su sitio real alrededor de la mesa. En la Fase 6, su voz sonará desde esa dirección (audio 3D).',
    plan_done: 'Listo',
  ...
  en: {
    ...
    plan_hint: 'Drag each person to their real seat around the table. In Phase 6, their voice will come from that direction (3D audio).',
    plan_done: 'Done',
  ...
  ko: {
    ...
    plan_title: '테이블 배치',
    plan_hint: '각 사람을 실제 자리로 드래그하세요. 6단계에서는 그 방향에서 목소리가 들립니다 (3D 오디오).',
    plan_done: '완료',
    mute_title: '마이크 음소거',
    enroll_title: '음성 보정',
